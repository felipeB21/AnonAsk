import { clsxMerge, joinClassNames } from "@/lib/utils";
  ...
  ),
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-blue-50 stroke-blue-700 px-6 text-blue-700 hover:bg-blue-100",
        outlined:
    ...
    compoundVariants: [
      {
        ...
        class:
          "disabled:bg-slate-100 disabled:stroke-slate-400 disabled:text-slate-400 disabled:hover:bg-slate-100",
      },
      {
        variant: ["outlined"],
        class:
